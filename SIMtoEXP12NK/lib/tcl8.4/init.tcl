...
#
# ActiveState ActiveTcl 8.4.13.0.261555 Win32/x86, Mon Apr 17 9:42:04 AM Pacific Daylight Time 2006
#
...
namespace eval ::activestate {
	...
	maturity      {final}
	arch          {win32-ix86}
	buildtime,sec {1145292124}
	buildtime,fmt {Mon Apr 17 9:42:04 AM Pacific Daylight Time 2006}
	as,mode       {normal}
    }
    ...
    variable  config
    array set config {
	{ActiveTcl} {ActiveState ActiveTcl 8.4.13.0.261555 Win32/x86 @ Mon Apr 17 9:42:04 AM Pacific Daylight Time 2006 / normal}
    }
}

package provide {ActiveTcl} {8.4.13.0.261555}
