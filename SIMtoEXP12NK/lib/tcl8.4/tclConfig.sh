...
TCL_EXEC_PREFIX='C:/Program Files/Tcl'
...
# String to pass to linker to pick up the Tcl library from its
# installed directory.
TCL_LIB_SPEC='-LC:/Program Files/Tcl/lib -ltcl84'
...
TCL_PACKAGE_PATH='C:/Program Files/Tcl/lib C:/Program Files/Tcl/lib'
...
# String to pass to linker to pick up the Tcl stub library from its
# installed directory.
TCL_STUB_LIB_SPEC='-LC:/Program Files/Tcl/lib -ltclstub84'
...
TCL_STUB_LIB_PATH='C:/Program Files/Tcl/lib/tclstub84.lib'
