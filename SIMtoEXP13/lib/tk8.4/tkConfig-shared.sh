...
# installed.
TK_PREFIX='C:/Program Files/Tcl'

# Top-level directory in which Tcl's platform-specific files (e.g.
# executables) are installed.
TK_EXEC_PREFIX='C:/Program Files/Tcl'
...
# String to pass to linker to pick up the Tk library from its
# installed directory.
TK_LIB_SPEC='-LC:/Program Files/Tcl/lib -ltk84'
...
# String to pass to linker to pick up the Tk stub library from its
# installed directory.
TK_STUB_LIB_SPEC='-LC:/Program Files/Tcl/lib -ltkstub84'
...
TK_STUB_LIB_PATH='C:/Program Files/Tcl/lib/tkstub84.lib'
